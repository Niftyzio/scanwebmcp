...
*The first implementation of this rubric is [ScanWebMCP.com](/) — which is itself agent-callable, because a rubric about callability that an agent cannot call would be embarrassing.*
